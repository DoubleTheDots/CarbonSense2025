...
from math import factorial as float_factorial
import numpy as _np

def convolve1d(x, w, axis=-1, mode="constant", cval=0.0):
    # minimal replacement: only 'constant' mode, same length output
    return _np.apply_along_axis(
        lambda v: _np.convolve(v, w, mode="same"), axis, x)
